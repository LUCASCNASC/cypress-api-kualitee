// Testes automatizados para API: POST /test_case/tree_testcase_in_build_ts
...
describe('API - Test Case Tree in Build TS - /test_case/tree_testcase_in_build_ts', () => {
  ...
  function testCaseTreeInBuildTs(body, options = {}) {
    return cy.request({
      method: 'POST',
      url: `${BASE_URL}/TestCase/TreeTestCaseinBuildTS`,
      form: true,
      body,
  ...
  it('Retorna árvore de casos de teste em build TS com token, project_id e test_scenario_id válidos', () => {
  ...
  ['project_id', 'test_scenario_id'].forEach(field => {
    it(`Falha sem campo obrigatório: ${field}`, () => {
      ...
      delete body[field];
      testCaseTreeInBuildTs(body).then(response => {
