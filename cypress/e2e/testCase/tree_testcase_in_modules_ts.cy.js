// Testes automatizados para API: POST /test_case/tree_testcase_in_modules_ts
...
describe('API - Test Case Tree in Modules TS - /test_case/tree_testcase_in_modules_ts', () => {
  ...
  function testCaseTreeInModulesTs(body, options = {}) {
    return cy.request({
      method: 'POST',
      url: `${BASE_URL}/TestCase/TreeTestCaseinModulesTs`,
      form: true,
      body,
  ...
  it('Retorna árvore de casos de teste em módulos TS com token, project_id e test_scenario_id válidos', () => {
  ...
  ['project_id', 'test_scenario_id'].forEach(field => {
    it(`Falha sem campo obrigatório: ${field}`, () => {
      ...
      delete body[field];
      testCaseTreeInModulesTs(body).then(response => {
