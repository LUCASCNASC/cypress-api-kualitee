// Testes automatizados para API: POST /test_scenario/tree_modules_ts
// Segue o padrão dos testes Cypress do projeto

describe('API - Tree TestScenarios In Modules - /test_scenario/tree_modules_ts', () => {
  ...
  function treeModulesTS(body, options = {}) {
    return cy.request({
      method: 'POST',
      url: `${BASE_URL}/Test%20Scenario/TreeTestScenariosInModules`,
      form: true,
      body,
  ...
  it('Retorna os cenários na árvore de módulos com campos obrigatórios válidos', () => {
    treeModulesTS({
      token: validToken,
